...
export const services = [
  ...
  },
  {
    ...
    icon: 'Brain',
    tagline: 'Expert dietetic support tailored to the unique demands of brain injury recovery.',
    description:
      'Acquired brain injury — including stroke, traumatic brain injury (TBI), hypoxic brain injury, and post-surgical recovery — creates highly specific nutritional challenges that require specialist expertise. Jackie draws on over 30 years of NHS experience, including working alongside multidisciplinary rehabilitation teams, to provide the kind of clinical dietetic support that is often difficult to access once inpatient care ends.',
    symptoms: [
      'Swallowing difficulties (dysphagia) making safe eating a challenge',
      'Significant weight loss or malnutrition risk during rehabilitation',
      'Fatigue that makes meal preparation or eating independently very difficult',
      'Altered taste or smell affecting appetite and food tolerance',
      'Cognitive changes — including memory, attention, or impulsivity — that affect eating behaviour',
      'Ongoing dietetic need following discharge from NHS inpatient rehabilitation',
    ],
    howHelps:
      'Jackie has worked within NHS multidisciplinary brain injury rehabilitation teams and understands the full complexity of supporting someone through recovery — from the acute phase through to returning home. She provides thorough individualised assessment covering nutritional adequacy, safe texture-modified dietary advice where dysphagia is present, weight and lean mass management, and practical strategies for eating and cooking independently as cognition and physical ability improve. For families and carers, she also provides clear guidance on supporting a loved one\'s nutritional recovery at home. Many families find that the NHS dietetic input they valued during inpatient rehabilitation simply isn\'t available once their relative is discharged — Jackie\'s private practice is designed precisely to fill that gap.',
    outcomes: [
      'Nutritional status supported and optimised throughout the recovery journey',
      'Safe eating approaches for those managing dysphagia',
      'Weight and muscle mass managed appropriately for rehabilitation goals',
      'Practical meal strategies matched to current cognitive and physical ability',
      'Clear, supportive guidance for families and carers at home',
      'Continuity of specialist dietetic care beyond NHS discharge',
    ],
    colour: 'stone',
  },
  {
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — this is a specialist area Jackie has worked in throughout her NHS career. Acquired brain injury, including stroke and traumatic brain injury, creates complex nutritional challenges: dysphagia (swallowing difficulties), significant fatigue, altered taste and smell, cognitive changes that affect eating behaviour, and malnutrition risk. Jackie provides individualised dietetic support that addresses all of these, and also supports families and carers who are managing a loved one\'s nutritional recovery at home. One of the most common situations she sees is families who received excellent dietetic support during NHS inpatient rehabilitation and then found that support disappeared at discharge. Her private practice is specifically able to provide that continuity.',
  },
  {
